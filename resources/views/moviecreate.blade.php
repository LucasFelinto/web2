...
<body>
    <div class="container is-fluid columns">
        ...
        <div class="field">
            ...
            <div class="control">
            <input type="number" name="release_year" placeholder="ano de lançamento" class="input">
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
            <input type="text" name="director" placeholder="diretor" class="input">
        </div>
